  ...
  describe('DockPanel', () => {
    ...
    describe('#onChildRemoved()', () => {
      ...
      it('should be invoked when a child is removed', (done) => {
        ...
        LogPanel.messages = [];
        panel.children = [];
        expect(LogPanel.messages.indexOf('child-removed')).to.not.be(-1);
        requestAnimationFrame(() => {
          expect(LogPanel.messages.indexOf('layout-request')).to.not.be(-1);
          done();
        });
    ...
    describe('#onChildMoved()', () => {
      ...
      it('should be invoked when a child is moved', (done) => {
        ...
        LogPanel.messages = [];
        panel.moveChild(1, 0);
        expect(LogPanel.messages.indexOf('child-moved')).to.not.be(-1);
        requestAnimationFrame(() => {
          expect(LogPanel.messages.indexOf('layout-request')).to.not.be(-1);
          done();
        });
    ...
    describe('#onAfterShow()', () => {
      ...
      it('should be invoked when the panel is shown', () => {
        ...
        panel.hidden = true;
        panel.hidden = false;
        expect(LogPanel.messages.indexOf('after-show')).to.not.be(-1);
      });
    ...
    describe('#onBeforeDetach()', () => {
      ...
      it('should be invoked when the panel is detached', () => {
        ...
        attachWidget(panel, document.body);
        detachWidget(panel);
        expect(LogPanel.messages.indexOf('before-detach')).to.not.be(-1);
      });
    ...
    describe('#onChildShown()', () => {
      ...
      it('should be invoked when a child is shown', (done) => {
        ...
        attachWidget(panel, document.body);
        widget.hidden = false;
        expect(LogPanel.messages.indexOf('child-shown')).to.not.be(-1);
        requestAnimationFrame(() => {
          expect(LogPanel.messages.indexOf('layout-request')).to.not.be(-1);
          done();
        });
    ...
    describe('#onChildHidden()', () => {
      ...
      it('should be invoked when a child is hidden', (done) => {
        ...
        attachWidget(panel, document.body);
        widget.hidden = true;
        expect(LogPanel.messages.indexOf('child-hidden')).to.not.be(-1);
        requestAnimationFrame(() => {
          expect(LogPanel.messages.indexOf('layout-request')).to.not.be(-1);
          done();
        });
    ...
    describe('#onResize()', () => {
      ...
      it('should be invoked on resize event', () => {
        ...
        expect(LogPanel.messages.indexOf('resize')).to.not.be(-1);
      });
    ...
    describe('#onUpdateRequest()', () => {
      ...
      it('should be invoked on update', () => {
        ...
        attachWidget(panel, document.body);
        panel.update(true);
        expect(LogPanel.messages.indexOf('update-request')).to.not.be(-1);
      });
